export default function ProcessPage() {
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-[1200px] mt-7 mx-auto px-5 md:px-10">
        <h3 className="text-pp-purple text-cs-24 font-bold">Our Process</h3>
        ...
        <div className="flex flex-wrap gap-5 mt-20">
          <div className="max-w-64">
            ...
            <p className="text-pp-dark text-cs-18 mt-8 mb-5 border-l-[3px] border-pp-purple pl-1">
              47+ Components
            </p>
