...
export function BuildSection() {
  return (
    <Container className="flex flex-wrap justify-between">
      <img
        src="/advanced-homepage/image-3.png"
        alt=""
      ...
      <div className="max-w-[500px]">
        ...
        <p className="text-ah-gray max-w-[400px] mt-6">
          Our approach to content creation allows you to build your content in
          multiple ways, maximizing your efficiency and output.
        </p>
        <CheckItem className="mt-6">
          Identify the core message of your content
        </CheckItem>
        <CheckItem className="mt-3">Create a content calendar</CheckItem>
