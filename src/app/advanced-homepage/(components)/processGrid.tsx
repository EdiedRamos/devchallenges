    ...
    <div className="relative mt-[72px]">
      <Container className="relative flex flex-wrap justify-evenly">
        <div className="w-full max-w-[200px]">
          ...
          <p className="text-ah-white mt-8 text-center">
            200+ cloneable components
          </p>
          <p className="text-ah-gray mt-5 text-center">
            Suspendisse id tortor venenatis, blandit lacus ut, efficitur diam.
            Proin vulputate nisl vel sem consequat euismod.
          </p>
        </div>
        <div className="w-full max-w-[200px]">
          <div className="bg-ah-blue w-20 h-20 rounded-lg flex justify-center items-center mx-auto">
